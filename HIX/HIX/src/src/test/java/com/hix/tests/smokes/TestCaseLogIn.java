...
import com.hix.testpages.LogInToYourAccount;
 ...
 */
public class TestCaseLogIn extends BaseTestCase {

	public DisplayHomePage displayHomePage = new DisplayHomePage();
	public LogInToYourAccount logInToYourAccount = new LogInToYourAccount();
